...
A ML application which uses PyTorch to classify Covid-19 chest X-ray images for COVID-19 detection. It differentiates normal and viral pneumonia, and COVID-19 radiographs. 
